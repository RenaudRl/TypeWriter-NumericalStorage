...
data class LevelCriteria(
    ...
    @Help("If true and mode is PLACEHOLDER, deduct the required value from the source when criteria is met.")
    val deductOnMet: Boolean = false,
    @Help("Command to execute to deduct the required value (e.g. 'eco take {player} {amount}'). Placeholder: {amount}, {player}.")
    val deductCommand: String = ""
) {
    /**
